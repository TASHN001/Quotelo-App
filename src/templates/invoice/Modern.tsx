  ...
  return (
    <InvoiceLayout
      ...
      styles={{
        ...
        logoContainer: 'flex-shrink-0 w-20 h-20',
        invoiceTitle: 'text-3xl sm:text-5xl md:text-6xl font-bold text-orange-600',
        invoiceNumber: 'text-sm sm:text-base text-gray-900 font-semibold',
        invoiceNumberLabel: 'text-xs font-semibold text-orange-600 uppercase tracking-widest',
        metaRow: 'grid grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-5',
        ...
        dateRow: 'mb-4 sm:mb-5',
        dateLabel: 'text-xs font-semibold text-orange-700 uppercase',
        dateValue: 'text-xs sm:text-sm text-gray-900 mt-1',
        tableContainer: 'w-full overflow-x-auto mb-5 sm:mb-6 rounded-xl overflow-hidden shadow-sm -mx-4 sm:mx-0',
        ...
        totalsContainer: 'flex justify-end mb-5 sm:mb-6',
        ...
        footer: 'space-y-2 sm:space-y-3 mt-4 sm:mt-5',
